...
const appUsageGraphStyle = {
    width: "66%"
};

const deviceUsageTableStyle = {
    width: "100%"
};

const deviceUsageTop5Style = {
    width: "37%"
};

const deviceUsageDoughnutCanvasStyle = {
    margin: "15px 10px 10px 0"
};

const profileCompletionDoughnutCanvasStyle = {
    width: "160px",
    height: "100px"    
}

const visitorsLocationWorldMapStyle = {
    height: "230px"
}
            ...
            <div className="col-md-12 col-sm-12 col-xs-12">
              <div className="dashboard_graph">
                ...
                <div className="row x_title">
                  ...
                  <div className="col-md-6">
                    <div id="reportrange" className="pull-right" style={reportStyle}>
                ...
                <div className="col-md-3 col-sm-3 col-xs-12 bg-white">
                  ...
                  <div className="col-md-12 col-sm-12 col-xs-6">
                    <div>
                      ...
                      <div className="">
                        <div className="progress progress_sm" style={progressGraphStyle}>
          ...
          <div className="row">
                  ...
                  <div className="widget_summary">
                    ...
                    <div className="w_center w_55">
                      <div className="progress">
                        <div className="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style={appUsageGraphStyle}>
            ...
            <div className="col-md-4 col-sm-4 col-xs-12">
              <div className="x_panel tile fixed_height_320 overflow_hidden">
                ...
                <div className="x_content">
                  <table className="" style={deviceUsageTableStyle}>
                  <tbody>
                    <tr>
                      <th style={deviceUsageTop5Style}>
                        <p>Top 5</p>
                      </th>
                      <th>
                    ...
                    <tr>
                      <td>
                        <canvas className="canvasDoughnut" height="140" width="140" style={deviceUsageDoughnutCanvasStyle}></canvas>
                      </td>
                      <td>
                ...
                <div className="x_content">
                  <div className="dashboard-widget-content">
                    ...
                    <div className="sidebar-widget">
                        ...
                        <canvas width="150" height="80" id="chart_gauge_01" className="" style={profileCompletionDoughnutCanvasStyle}></canvas>
                  ...
                  <div className="x_panel">
                    ...
                    <div className="x_content">
                      <div className="dashboard-widget-content">
                        ...
                        <div id="world-map-gdp" className="col-md-8 col-sm-12 col-xs-12" style={visitorsLocationWorldMapStyle}></div>
                      </div>
                    </div>
                  </div>
                </div>
